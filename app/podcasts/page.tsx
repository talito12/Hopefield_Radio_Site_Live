        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                { id: 'qUE_ghhJirc', title: 'REAL vs. FAKE: Masculinity, Marriage + The Cost of Deception', description: 'The artificial world of the internet, The biblical definition of Masculinity and Femininity + The cost of Deception'},
                { id: 'qE3IUD2-YGU', title: 'The Mirror & The Tribe: Authenticity, Community, and What Marriage Actually Requires', description: 'The importance of vulnerability, community and being seen in marriage. What marriage actually requires in order to work'},
